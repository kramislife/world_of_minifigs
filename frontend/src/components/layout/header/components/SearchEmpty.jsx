...
export const SearchEmpty = ({ searchQuery, handleSearch }) => (
  <div className="flex flex-col items-center justify-center text-center p-5 py-10">
    ...
    <p className="text-gray-400 mb-6">
      ...
      checking for typos or using more general terms.
    </p>
    <Button
      variant="buyNow"
...
export const NoSearchHistory = () => (
  <div className="flex flex-col items-center justify-center text-center p-5 py-10">
    ...
    <p className="text-gray-400 mb-6">
      Your recent searches will appear here. Try searching for
      products, categories, or collections to get started.
    </p>
  </div>
);
